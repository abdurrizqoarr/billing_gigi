<div class="w-full grid grid-cols-2 gap-6">
        ...
        <div class="flex-1 overflow-y-auto space-y-2">
            @foreach ($dataList as $item)
                <div
                    ...
                    <button wire:click="terapkan('{{ $item->id }}')"
    ...
    <!-- Panel Kanan : data yang Diterapkan -->
    <div class="bg-white rounded-2xl shadow-md p-4 flex flex-col max-h-[28rem] overflow-auto">
        <h3 class="text-lg font-semibold text-gray-700 mb-3">Obat Diterapkan</h3>

        <div class="flex-1 overflow-y-auto space-y-2">
            @forelse($dataTerpilih as $item)
                <div
