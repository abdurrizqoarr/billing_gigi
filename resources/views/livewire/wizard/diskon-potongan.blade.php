<div class="w-full grid grid-cols-2 gap-6">
    ...
    <div class="bg-white rounded-2xl shadow-md p-5 flex flex-col max-h-[28rem]">
        <!-- Input Diskon -->
        <div class="mb-3">
            <input type="text" name="diskon" id="diskon" wire:model="diskon"
                class="w-full bg-white border @error('diskon') border-red-400 @else border-sky-300 @enderror 
                   rounded-2xl px-4 py-2 shadow-sm 
                   focus:outline-none focus:ring-2 @error('diskon') focus:ring-red-400 focus:border-red-400 @else focus:ring-sky-400 focus:border-sky-400 @enderror
    ...
    <div class="bg-white rounded-2xl shadow-md p-5 flex flex-col max-h-[28rem]">
        <h3 class="text-lg font-semibold text-gray-700 mb-3">Diskon dan Potongan</h3>

        <div class="flex-1 overflow-y-auto space-y-2">
            @forelse($listDiskon as $item)
                <div
